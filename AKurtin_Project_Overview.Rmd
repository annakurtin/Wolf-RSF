...
- cross validation to assess how well it will apply to other areas

7.	Spatial prediction (mapping). 

# Do two separate models for packs and show if they are fit better than the combined model but then talk about how for predictions sake it makes more sense to do a combined model 
